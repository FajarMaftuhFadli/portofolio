export default function Footer() {
  return (
    <footer className="text-gray-900 bg-gray-100">
      <div className="container flex flex-col p-4 mx-auto divide-gray-600 md:p-8 lg:flex-row">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 bg-blue-600 rounded-full sm:w-10 sm:h-10 text-gray-50"
            >
              <svg
